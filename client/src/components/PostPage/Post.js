        ...
        <div className="post-container shadow mt-3">
            ...
            <div className="post-section">
                <button className="post-button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" style={{ paddingTop: 2 }} fill="currentColor" className="bi bi-heart" viewBox="0 0 16 16">
                ...
                <button className="post-button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cursor" viewBox="0 0 16 16">
